...
@implementation UIImage (ASHUtil)

+ (UIImage*)ash_imageFromColor:(UIColor*)color andSize:(CGSize)size
{
    return [self ash_imageFromColor:color andSize:size opaque:NO];
}

+ (UIImage*)ash_imageFromColor:(UIColor*)color andSize:(CGSize)size opaque:(BOOL)opaque
{
    if (color == nil) {
